...
#define REG_TYPE 1		// 0: scalar, 1: sse
#define KEY_TYPE 0		// 0: 32
#define MERGE_TYPE 2 	// 0: nplusmplus1 1: binaryMerge 2: scalarOddEvenMerge 3: scalarMerge (Origami Merge)
